...
import { User, Lock, Mail, BadgeCheck, IdCard } from "lucide-react";
        ...
        <div className="min-h-[100dvh] bg-green-50 bg-[radial-gradient(#dcfce7_1px,transparent_1px)] [background-size:16px_16px] py-10 px-6 overflow-y-auto">
            <div className="w-full max-w-md mx-auto">
                <header className="mb-8 text-center flex items-center justify-center gap-3">
                    ...
                    <h1 className="text-3xl font-black text-green-900 uppercase tracking-tighter">Intern Registration</h1>
                </header>
                ...
                <form onSubmit={handleRegister} className="bg-white p-7 border-2 border-green-900 relative mb-8">
                    <div className="absolute inset-0 bg-green-900 -z-10 translate-x-2 translate-y-2"></div>

                    <h2 className="font-black text-gray-900 text-xl mb-6 uppercase tracking-wide border-b-2 border-green-900 pb-4">Personal Details</h2>
                    ...
                    <div className="space-y-4 mb-8">
                        ...
                        <div className="pt-2">
                            <label className="block text-[10px] font-black tracking-widest uppercase text-gray-500 mb-2">Create Password</label>
                            <div className="relative border-2 border-green-900 flex items-stretch">
                                <div className="bg-green-100 px-4 flex items-center border-r-2 border-green-900">
                        ...
                        <div className="pt-2">
                            <label className="block text-[10px] font-black tracking-widest uppercase text-gray-500 mb-2">Confirm Password</label>
                            <div className="relative border-2 border-green-900 flex items-stretch">
                                <div className="bg-green-100 px-4 flex items-center border-r-2 border-green-900">
                                    <Lock size={18} strokeWidth={3} className="text-green-900" />
                                </div>
                ...
                <div className="text-center font-bold text-sm text-gray-600 bg-white p-4 border-2 border-green-900">
                    ...
                    <Link to="/login" className="text-green-700 hover:text-green-900 uppercase tracking-widest underline decoration-2 underline-offset-4 mt-2 inline-block">
                        Return to Log In
                    </Link>
                </div>
            </div>
