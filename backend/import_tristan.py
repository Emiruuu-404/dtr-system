...
def import_tristan():
    print("🎯 Importing specifically for Dela Cruz, Tristan Marc P. ...")
    intern = Intern.objects.get(student_id="22-0005")
    ...
    # For Tristan, his block is roughly rows 168 to 201
    processed_count = 0
    for idx in range(167, 202): 
        row = rows[idx]
    ...
    print(f"\n✨ Done! Tristan Total Hours: {intern.total_hours}")
