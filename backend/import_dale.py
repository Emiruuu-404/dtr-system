...
def import_dale():
    print("🎯 Importing specifically for Sandagon, Dale Mar B. ...")
    intern = Intern.objects.get(student_id="22-0004")
    ...
    # For Dale, his block is roughly rows 125 to 157
    processed_count = 0
    for idx in range(124, 158): 
        row = rows[idx]
    ...
    print(f"\n✨ Done! Dale Total Hours: {intern.total_hours}")
