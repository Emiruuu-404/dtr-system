...
def import_princes():
    print("🎯 Importing specifically for Beraquit, Princes May A. ...")
    intern = Intern.objects.get(student_id="22-0007")
    ...
    # For Princes, her block is roughly rows 286 to 316
    processed_count = 0
    for idx in range(285, 317): 
        row = rows[idx]
        
        offset = 1 # Jan at col 2, etc.
        GROUPS = [
    ...
    print(f"\n✨ Done! Princes Total Hours: {intern.total_hours}")
